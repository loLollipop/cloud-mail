const zh = {
    ...
    mailDomainManage: '邮箱域名',
    mailDomainManageDesc: '管理项目内可用邮箱域名。保存后立即生效；同步 Cloudflare 会把这些域名写入当前 Worker 的 domain 变量。',
    syncCloudflare: '同步 Worker 变量',
    cloudflareSyncSuccessMsg: 'Worker domain 变量同步成功',
    invalidDomainMsg: '域名格式不正确',
    emptyDomainListMsg: '至少保留一个域名',
    blackList: '邮件黑名单',
