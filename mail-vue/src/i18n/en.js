const en = {
    ...
    mailDomainManageDesc: 'Manage domains available in this project. Save applies immediately; syncing Cloudflare writes the list to the current Worker domain variable.',
