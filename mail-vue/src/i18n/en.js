const en = {
    ...
    mailDomainManage: 'Mail Domains',
    mailDomainManageDesc: 'Manage mail domains in this project. Save applies immediately; users can register and add mailboxes only with enabled domains. Sync Worker Variable writes all domains.',
    syncCloudflare: 'Sync Worker Variable',
    cloudflareSyncSuccessMsg: 'Worker domain variable synced',
    invalidDomainMsg: 'Invalid domain',
    emptyDomainListMsg: 'Add at least one domain',
