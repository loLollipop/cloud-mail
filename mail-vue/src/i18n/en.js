const en = {
    ...
    mailDomainManageDesc: 'Manage domains available in this project. Cloudflare Email Routing still needs to be configured for each domain.',
    syncCloudflare: 'Sync Cloudflare',
    cloudflareSyncSuccessMsg: 'Cloudflare Email Routing synced',
